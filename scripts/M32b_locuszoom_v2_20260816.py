#!/usr/bin/env python3
# =============================================================================
# M32b_locuszoom_v2_20260816.py — Fig 5 v2：区域共定位镜像图（LAMC1→RIC8A，随 FDR-core 15 候选更新）
# =============================================================================
# AJHG 审稿人核心期待：逐基因座"上 GWAS −log10p / 下 eQTL −log10p / 共享基因轨道 /
#   PP.H4 直标"的镜像图。6 个代表位点 = 5 个 susie 敏感性候选（RBM6/CNNM2/PLAUR/CD101/RIC8A）
...
LOCI = [
    ...
    dict(sym="RIC8A", ensg="ENSG00000177963", out="cad", chr=11, pos=211312,    anchor="rs6598075",  grey=False),
...
fig.suptitle("Representative colocalization loci: 5 coloc.susie-sensitivity candidates + 1 grey-zone locus (GWAS / eQTL mirror plots; LD vs lead eQTL SNP, 1000G EUR; selection criterion: top PP.H4 among FDR-core candidates)",
             fontsize=9, y=0.995)
out_p = f"{OUT}/20260816_F5_locuszoom_mirror_v2.png"
